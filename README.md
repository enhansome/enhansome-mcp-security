...
# Awesome MCP Security with stars
...
> \[!NOTE]
> 15.04.2025: The current MCP [auth specification](https://modelcontextprotocol.io/specification/2025-03-26/basic/authorization) is in progress of being replaced by a more [robust specification](https://github.com/modelcontextprotocol/specification/pull/284) ⭐ 8,956 | 🐛 168 | 🌐 TypeScript | 📅 2026-08-12. Please join the conversation if you have concerns around the current auth specification.
...
* (07.04.2025) [(RFC) Update the Authorization specification for MCP servers #284 by localden](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/284) ⭐ 8,956 | 🐛 168 | 🌐 TypeScript | 📅 2026-08-12
* (14.04.2025) [MCP Security Checklist: A Security Guide for the AI Tool Ecosystem by slowmist](https://github.com/slowmist/MCP-Security-Checklist) ⭐ 835 | 🐛 8 | 📅 2025-04-28
...
* (09.04.2025) [Here's an example of remote MCP malware that steals your .env secrets in @cursor\_ai by Maciej Pulikowski](https://x.com/pulik_io/status/1910053590921535992)
...
* [AI-Infra-Guard by Tencent Zhuque Lab](https://github.com/Tencent/AI-Infra-Guard) ⭐ 4,491 | 🐛 15 | 🌐 Python | 📅 2026-08-12 - MCP Server Security Analysis Tool - a comprehensive, intelligent, easy-to-use, and lightweight AI Infrastructure Vulnerability Assessment.
* [mcp-scan by invariantlabs-ai](https://github.com/invariantlabs-ai/mcp-scan) ⭐ 2,913 | 🐛 9 | 🌐 Python | 📅 2026-08-13
* [ToolHive - making MCP servers easy and secure by StacklokLabs](https://github.com/StacklokLabs/toolhive) ⭐ 2,011 | 🐛 369 | 🌐 Go | 📅 2026-08-14
* [Damn Vulnerable MCP Server by harishsg993010](https://github.com/harishsg993010/damn-vulnerable-MCP-server) ⭐ 1,333 | 🐛 19 | 🌐 Python | 📅 2025-12-08
* [Octocode](https://github.com/bgauryy/octocode-mcp) ⭐ 908 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-12 - AI-powered developer assistant that enables advanced research, analysis and discovery across GitHub ecosystem. Allow smart search of security patterns across repositories.
* [MCP Security Checklist: A Security Guide for the AI Tool Ecosystem by SlowMist](https://github.com/slowmist/MCP-Security-Checklist) ⭐ 835 | 🐛 8 | 📅 2025-04-28
* [workers-mcp - Connect Cloudflare Workers with your MCP clients by Cloudflare](https://github.com/cloudflare/workers-mcp) ⭐ 644 | 🐛 23 | 🌐 TypeScript | 📅 2026-04-23
* [MCP-Shield – Detect security issues in MCP servers by riseandignite](https://github.com/riseandignite/mcp-shield) ⭐ 555 | 🐛 6 | 🌐 TypeScript | 📅 2025-04-26
* [Google Security Operations and Threat Intelligence MCP Server - Access Google's security products and services](https://github.com/google/mcp-security) ⭐ 517 | 🐛 86 | 🌐 Python | 📅 2026-08-13
* [MCP Gateway - Acts as intermediary between LLMs and other MCP servers by lasso-security](https://github.com/lasso-security/mcp-gateway) ⭐ 385 | 🐛 12 | 🌐 Python | 📅 2026-01-22
* [MCP Defender - Blocks malicious MCP traffic](https://github.com/MCP-Defender/MCP-Defender) ⭐ 255 | 🐛 5 | 🌐 TypeScript | 📅 2026-06-05
* [mcp-context-protector - Security wrapper for MCP servers by trailofbits](https://github.com/trailofbits/mcp-context-protector) ⭐ 222 | 🐛 14 | 🌐 Python | 📅 2026-04-14
* [MCP Tool Poisoning Experiments by invariantlabs-ai](https://github.com/invariantlabs-ai/mcp-injection-experiments) ⭐ 204 | 🐛 3 | 🌐 Python | 📅 2025-04-10
* [mcp-injection-experiments by invariantlabs-ai](https://github.com/invariantlabs-ai/mcp-injection-experiments) ⭐ 204 | 🐛 3 | 🌐 Python | 📅 2025-04-10
* [MCP Guardian - Manage your LLM's access to MCP servers by eqtylab](https://github.com/eqtylab/mcp-guardian) ⭐ 199 | 🐛 15 | 🌐 Rust | 📅 2025-08-08
* [Secure MCP - Security auditing tool to detect MCP vulnerabilities and misconfigurations by makalin](https://github.com/makalin/SecureMCP) ⭐ 140 | 🐛 3 | 🌐 Go | 📅 2025-06-07
* [MCP Watch - Vulnerability scanner for MCP servers](https://github.com/kapilduraphe/mcp-watch) ⭐ 135 | 🐛 13 | 🌐 TypeScript | 📅 2026-07-20
* [AWS Security MCP - Access AWS security tools by groovyBugify](https://github.com/groovyBugify/aws-security-mcp) ⭐ 84 | 🐛 1 | 🌐 Python | 📅 2025-07-25]
* [MCP-Dandan](https://github.com/82ch/MCP-Dandan) ⭐ 65 | 🐛 0 | 🌐 Python | 📅 2026-08-10 - Desktop security tool for real-time monitoring, threat detection, and control of MCP tool invocations.
* [MCPAuth: Gateway Authentication for Secure Enterprise MCP Integrations by Oide Brett](https://github.com/oidebrett/mcpauth) ⭐ 32 | 🐛 1 | 🌐 Go | 📅 2026-05-27
* [MCP Audit Extension - Audit and log all GitHub Copilot MCP tool calls in VSCode with ease](https://github.com/Agentity-com/mcp-audit-extension) ⭐ 27 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-04
* [MCP Ethical Hacking by cmpxchg16](https://github.com/cmpxchg16/mcp-ethical-hacking) ⭐ 19 | 🐛 2 | 🌐 Python | 📅 2025-09-16
...
* [IDA-Pro-MCP by mrexodia](https://github.com/mrexodia/ida-pro-mcp) ⭐ 11,346 | 🐛 45 | 🌐 Python | 📅 2026-08-09 - MCP server for reverse engineering in IDA Pro, a tool for analyzing software and binary files.
* [GhidraMCP by LaurieWired](https://github.com/LaurieWired/GhidraMCP) ⭐ 9,779 | 🐛 82 | 🌐 Java | 📅 2025-06-23 - MCP server for automatic reverse engineering in Ghidra, a software reverse engineering platform.
* [pomerium/pomerium](https://github.com/pomerium/pomerium) ⭐ 4,954 | 🐛 148 | 🌐 Go | 📅 2026-08-14 - Identity-aware proxy with native support for Zero Trust access, now including MCP support.
...
* [Burp Suite MCP by PortSwigger](https://github.com/PortSwigger/mcp-server) ⭐ 1,067 | 🐛 47 | 🌐 Kotlin | 📅 2026-08-13 - MCP integration for web security testing in Burp Suite, a security testing tool for web applications.
* [Semgrep MCP Server](https://github.com/semgrep/mcp) ⚠️ Archived - MCP server for using Semgrep to scan code for vulnerabilities
* [BloodHound-MCP-AI by MorDavid](https://github.com/MorDavid/BloodHound-MCP-AI) ⭐ 373 | 🐛 0 | 🌐 Python | 📅 2025-06-02 - MCP server integration for BloodHound, a tool for analyzing Active Directory domains.
* [Maigret MCP Server by BurtTheCoder](https://github.com/BurtTheCoder/mcp-maigret) ⭐ 257 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-27 - MCP server for OSINT data collection with Maigret, a tool that gathers user info from various sources.
* [Shodan MCP Server by BurtTheCoder](https://github.com/BurtTheCoder/mcp-shodan) ⭐ 153 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-31 - MCP server for querying the Shodan API, which provides data on Internet-connected devices.
* [VirusTotal MCP Server by BurtTheCoder](https://github.com/BurtTheCoder/mcp-virustotal) ⭐ 143 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-24 - MCP server for querying the VirusTotal API, a service for analyzing files and URLs for viruses.
...
* [Illumio MCP Server by alexgoller](https://github.com/alexgoller/illumio-mcp-server) ⭐ 12 | 🐛 3 | 🌐 Python | 📅 2026-08-03 - MCP server for interacting with Illumio Policy Compute Engine for Illumio workload management, label operations, traffic flow analysis
* [urldna/mcp](https://github.com/urldna/mcp) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-05-10 - urlDNA MCP server for phishing detection and URL analysis through advanced contextual scanning.
...
* [Awesome Cybersecurity Agentic AI](https://github.com/raphabot/awesome-cybersecurity-agentic-ai) ⭐ 534 | 🐛 10 | 🌐 Shell | 📅 2026-06-28 - Collection of resources on using AI agents for security use cases
...
[Please read and follow our contributing guide](https://github.com/Puliczek/awesome-mcp-security/blob/main/CONTRIBUTING.md) ⭐ 728 | 🐛 160 | 📅 2026-03-03
